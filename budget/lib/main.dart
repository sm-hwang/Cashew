...
void main() async {
  captureLogs(() async {
    ...
    // Firebase has no macOS config yet (firebase_options.dart throws
    // UnsupportedError for macOS). Don't let that crash app startup —
    // the app runs without cloud sync/auth until macOS is configured.
    try {
